...
provider with a conforming backend, a user will be warned if their download is
potentially compromised whenever the checksum uniquely identifying the resource
does not match a checksum advertised by the provider. In this way, false
negatives, \ie{a compromised resource not generating a warning}, 
