...
\SYSTEM{} addresses, followed by an examination of our Google Chrome extension.
...
Finally, we evaluate the obstacles to scalability and potential performance
overhead of our extensions.
...
\secref{availability}, where we make these implementations available open source
...
overhead compared to downloads without \SYSTEM{}.}

\TODO{Limitation: denial of service}

\TODO{go over the implications of a compromised backend}
