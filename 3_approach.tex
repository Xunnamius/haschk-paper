...
Unlike the Chrome extension, the FileZilla patch required no special
\emph{Origin Domain (OD)} resolution step. The domain to be used for backend
queries is the domain of the FTP server itself. The remainder of the
