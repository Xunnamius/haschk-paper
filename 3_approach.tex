...
Fortunately, there exists a relatively free (extra TXT resource records are
cheap and essentially limitless) highly-available fully authenticated globally
distributed high performance low latency mapping service that web-facing
organizations and IT teams are already quite familiar with: the Domain Name
System (DNS). To avoid co-location in our implementations, we preferred DNS to
other candidate highly-available authenticated systems for these reasons.
