...
\textit{https://somesite.com/var/downloadme.txt}, our implementation would hash
\textit{/var/downloadme.txt} to yield an RI.
...
\textit{/~user/var/downloadme.txt}, our implementation would hash
\textit{/~user/var/downloadme.txt} to yield an RI.
