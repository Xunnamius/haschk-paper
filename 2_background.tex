...
In this section, we discuss Supply Chain Attacks, including four case studies
describing real-world resource integrity attacks that take advantage of the
ineffectiveness of checksums. These motivate the \SYSTEM{} approach.
