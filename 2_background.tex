...
\begin{table*}[t]
    ...
    \end{tabular}
    \caption{The software development supply chain. Attacks on the deployment,
     maintenance, and retirement phases are in scope.} \label{tbl:attacks}
\end{table*}
...
the discrepancy between the two digests. Clearly, a majority of users do not
meet these criteria. \\
