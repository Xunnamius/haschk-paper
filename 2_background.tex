...
\TODO{(what it is, why it fails)}~\cite{HTTP, HTTPS, TLS1, TLS2, DTLS}
...
\noindent\textbf{Case 1: Floxif and CCleaner.} \TODO{Explain} \\

\noindent\textbf{Case 2: Linux Mint.} \TODO{Explain} \\

\noindent\textbf{Case 3: Kingslayer.} \TODO{Explain} \\

\noindent\textbf{Case 4: PhpMyAdmin.} \TODO{Explain} \\

\noindent\textbf{Case 5: Havex.} \TODO{Explain} \\
