...
\subsubsection{Mirrors, CDNs, and Redirection}
...
Naive RI resolution assumed a well-known path. Mirrors with well-known paths handled. Mirrors that change path handled with URNs. Mirrors that redirect users to another page and don't automate the download are handled with URNs. Mirrors that redirect and then automate the download may end up as false positives.

\subsection{Performance Overhead}

Describe how we measured this.
