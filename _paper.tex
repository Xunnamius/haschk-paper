...
\usepackage[natbib=true,backend=bibtex,style=numeric-comp,sorting=none,defernumbers,maxnames=99,maxcitenames=99]{biblatex}
\usepackage{balance}
...
%\date{}
\title{\Large \bf \SYSTEM{}: Automating Checksum Verification And Defeating Co-Hosting Leveraging High Availability Systems}
