...
\noindent\textbf{Digital Signatures/PKI} \TODO{(I think we should address the
differences explicitly: we're simpler; we don't make the system more fragile; no central authority; applicable to more than just software binaries)}
