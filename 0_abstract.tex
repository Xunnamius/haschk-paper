...
that with an authoritative checksum. Problems with this approach include (1) \emph{user
...
verification. We evaluate \SYSTEM{}'s security, practicality, and ease of deployment of
our approach by implementing two Google Chrome extensions. Our implementations
are tested versus common resource integrity violations. We find our approach is
more effective than existing mitigation methods, significantly raises the bar
for the attacker, and is deployable at scale. 
