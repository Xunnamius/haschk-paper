...
our approach through two DNS and DHT based implementations in Google Chrome and
Firefox. Implementations are tested versus common resource integrity violations.
We find our approach is more effective than existing mitigation methods,
significantly raises the bar for the attacker, and is deployable at scale.
