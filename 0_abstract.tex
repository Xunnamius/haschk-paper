...
\emph{user apathy}---for most users, calculating and validating the checksum is
...
resource validation protocol expanding on de facto checksum-based integrity
...
deployment of our approach by implementing a proof-of-concept Google Chrome
