...
like alter a download's \texttt{DangerType} property and alert the end user to
a dangerous download naturally. These modifications would have the advantage
of communicating intent through the browser's familiar UI and preventing the
...
\subsection{URNs vs RIs for Wider Compatibility}
